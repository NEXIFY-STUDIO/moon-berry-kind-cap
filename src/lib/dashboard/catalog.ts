...
export const TOOL_CATEGORIES: ToolCategoryDef[] = [
  ...
  },
  {
    ...
    descSk: "REST, CCT, listings, Elementor, sitemap",
  },
  {
    id: "export",
    labelEn: "Export",
    ...
    descSk: "JSON, Elementor template, ZIP, import",
  },
  {
    id: "ai",
    labelEn: "AI Rebuild",
...
export const TOOL_CARDS: ToolCardDef[] = [
  ...
  },
  {
    ...
    descSk: "Playwright SPA render namiesto raw HTML.",
  ...
  },
  {
    ...
    titleSk: "Wayback Fallback",
    descEn: "On failure, try an archive.org snapshot.",
    descSk: "Pri chybe skúsi archive.org snapshot.",
  ...
  },
  {
    ...
    descSk: "Same-origin multi-page crawl (až 5 stránok).",
  ...
  },
  {
    ...
    descSk: "REST, CCT, listings, Elementor, sitemap seed.",
  ...
  },
  {
    ...
    descSk: "Signály frameworkov z HTML, CSS a headers.",
  ...
  },
  {
    ...
    descSk: "Title, description, Open Graph, canonical.",
    action: { type: "tab", tab: "overview" },
  },
  {
    id: "design-tokens",
    ...
    titleSk: "Design Tokens",
    descEn: "Colors, fonts, typography, CSS variables.",
    descSk: "Farby, fonty, typografia, CSS variables.",
  ...
  },
  {
    ...
    descSk: "Outline, headings, links, hierarchia.",
  ...
  },
  {
    ...
    descSk: "Login, contact, booking a ďalšie formuláre.",
    action: { type: "tab", tab: "structure" },
  },
  {
    id: "thin-html-guard",
  ...
  },
  {
    ...
    descSk: "Reverse-engineering jet-listing-grid templates.",
    action: { type: "tab", tab: "wordpress" },
  },
  {
    id: "dynamic-fields",
  ...
  },
  {
    ...
    descSk: "data-id, role, headings zo sekcií.",
  ...
  },
  {
    ...
    titleSk: "Sitemap Seed",
    descEn: "Nav + footer + sitemap URL seed for crawl.",
    descSk: "Nav + footer + sitemap URL seed pre crawl.",
    action: { type: "tab", tab: "wordpress" },
  },
  {
    id: "export-json",
  ...
  },
  {
    ...
    descSk: "HTML + CSS + captured assets archív.",
    action: { type: "home", tool: "url-scan" },
  },
  {
    id: "import-json",
  ...
  },
  {
    ...
    descSk: "SPA UI Architecture Compiler prompt.",
  ...
  },
  {
    ...
    descSk: "Tailwind config snippet z design tokenov.",
    action: { type: "tab", tab: "ai-rebuild" },
  },
  {
    ...
    descSk: "Full system + user prompt studio.",
    action: { type: "tab", tab: "ai-rebuild" },
    tone: "info",
  },
  {
  ...
  },
  {
    ...
    descSk: "Diff title, hash, tech, links, assets, pages.",
  ...
  },
  {
    ...
    titleSk: "Partial Recovery",
    descEn: "Partial / aborted scan status and failed URLs.",
    descSk: "Partial / aborted status a failed URLs.",
    action: { type: "tab", tab: "overview" },
    tone: "warning",
  },
];
